...
class TravelViewModel: ObservableObject {
    ...
    @Published var items: [TravelItem] = [
        // Sample travel items with title, description, and image URL
        TravelItem(title: "Paris", description: "The city of light.", imageURL: "https://picsum.photos/seed/mountain/200/150", rating: 4.3),
        TravelItem(title: "Tokyo", description: "Explore the tech and culture.", imageURL: "https://picsum.photos/seed/beach/200/150", rating: 4.5),
        TravelItem(title: "New York", description: "The city that never sleeps.", imageURL: "https://picsum.photos/seed/city/200/150", rating: 3.8),
        TravelItem(title: "Sydney", description: "Home of the Opera House.", imageURL: "https://picsum.photos/seed/desert/200/150", rating: 2.4),
        TravelItem(title: "Rome", description: "The Eternal City with ancient history.", imageURL: "https://picsum.photos/seed/forest/200/150", rating: 3.1),
        TravelItem(title: "London", description: "Historic landmarks and vibrant life.", imageURL: "https://picsum.photos/seed/road/200/150", rating: 4.8),
        TravelItem(title: "Barcelona", description: "Art, beaches, and great food.", imageURL: "https://picsum.photos/seed/cliff/200/150", rating: 5.0),
        TravelItem(title: "Dubai", description: "Luxury and desert adventures.", imageURL: "https://picsum.photos/seed/village/200/150", rating: 4.7),
        TravelItem(title: "Cape Town", description: "Mountains, oceans, and culture.", imageURL: "https://picsum.photos/seed/balloons/200/150", rating: 4.1),
        TravelItem(title: "Rio de Janeiro", description: "Beaches, Carnival, and Christ the Redeemer.", imageURL: "https://picsum.photos/seed/lake/200/150", rating: 3.9)
    ]
}
